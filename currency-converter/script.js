      const apiKey = "d14eeee6a4f935aab34c335e"; // Replace with your actual API key
      const currencyNames = {
      ...
      const targetSelectors = document.getElementById(
        "targetCurrencySelectors"
      );
      ...
      function saveToLocalStorage() {
        localStorage.setItem(
          "targetCurrencies",
          JSON.stringify(targetCurrencies)
        );
